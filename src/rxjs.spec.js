...
describe('Rxjs', () => {
  ...
  describe('Operators', () => {
    ...
    describe('interval :', () => {
      ...
      it('should emit the sequence of values at n-second interval', (done) => {
    ...
    describe('startWith :', () => {
      it('should start with an number sequence', (done) => {
        const source$ = Observable.from([1, 2, 3, 4, 5]);
        let result = [];
    ...
    describe('concat :', () => {
      ...
      it('Concat should also be a static method', (done) => {
        const sourceOne$ = Observable.of(10);
        const sourceTwo$ = Observable.of(20);
        let result = [];
        const actual = [10, 20];
    ...
    describe('take :', () => {
      it('should return the first value from source', (done) => {
      ...
      it('should return the first 2 values from source', (done) => {
    ...
    describe('first :', () => {
      ...
      it('should return the first value to pass predicate', (done) => {
    ...
    describe('skip :', () => {
      it('should skip the first n values before emission', (done) => {
